...
- Uma função para capiturar os dados JSON chamada metadata_capture;
- Uma função de processamento e save das informações que foram capituradas chamada process_and_save_metadata;
